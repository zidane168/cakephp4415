        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title"> <?= __d('center', 'add_cidc_class'); ?> </h3>
                </div>
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="col-6" style="margin-bottom: 20px">
                                ...
                                <label style="margin-top: 20px"> <?php echo "<font class='red'> * </font>" . __d('center', 'date_of_lesson'); ?> </label>
