<div class="row filter-panel">
    <div class="col-md-12">
        ...
        echo $this->Form->create(NULL, array(
            $this->Url->build(['controller' => 'CidcHolidays', 'action' => 'index', 'admin' => true]),
            'class' => 'form_filter',
            'type' => 'get',
        ));
        ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('year', [
                        ...
                        'label' =>  __('year'),
                        'value' => isset($data_search['year']) && !empty($data_search['year']) ? $data_search['year'] : array()
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('description', array(
                        ...
                        'value' => isset($data_search['description']) && !empty($data_search['description']) ? $data_search['description'] : '',
                    ));
                    ?>
                </div>
                <div class="col-md-4">
