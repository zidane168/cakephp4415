<div class="row filter-panel">
    <div class="col-md-12">
        ...
        echo $this->Form->create(NULL, array(
            $this->Url->build(['controller' => 'CidcClasses', 'action' => 'index', 'admin' => true]),
            'class' => 'form_filter',
            'type' => 'get',
        ));
        ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('course_id', [
                        ...
                        'class' => 'selectpicker form-control',
                        'options' => $courses,
                        'label' =>  __d('center', 'course'),
                        'value' => isset($data_search['course_id']) && !empty($data_search['course_id']) ? $data_search['course_id'] : array()
