<div class="row filter-panel">
    <div class="col-md-12">
        ...
        echo $this->Form->create(NULL, array(
            $this->Url->build(['controller' => 'UserVerifications', 'action' => 'index', 'admin' => true]),
            'class' => 'form_filter',
            'type' => 'get',
        ));
        ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('phone_number', array(
                        'class' => 'form-control',
                        'label' => __('phone'),
                        'value' => isset($data_search['phone_number']) && !empty($data_search['phone_number']) ? $data_search['phone_number'] : '',
                    ));
                    ?>
                </div>
                <div class="col-md-4">
