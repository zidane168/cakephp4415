<div class="row filter-panel">
    <div class="col-md-12">
        ...
        echo $this->Form->create(NULL, array(
            $this->Url->build(['controller' => 'SystemMessages', 'action' => 'index', 'admin' => true]),
            'class' => 'form_filter',
            'type' => 'get',
        ));
        ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('cidc_parent_id', [
                        ...
                        'options' => $cidcParents,
                        'label' =>  __d('parent', 'cidc_parent'),
                        'value' => isset($data_search['cidc_parent_id']) && !empty($data_search['cidc_parent_id']) ? $data_search['cidc_parent_id'] : array()
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('cidc_class_id', [
                        ...
                        'class' => 'selectpicker form-control',
                        'options' => $cidcClasses,
                        'label' =>  __d('center', 'cidc_class'),
                        'value' => isset($data_search['cidc_class_id']) && !empty($data_search['cidc_class_id']) ? $data_search['cidc_class_id'] : array()
