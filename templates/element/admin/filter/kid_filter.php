<div class="row filter-panel">
    <div class="col-md-12">
        ...
        echo $this->Form->create(NULL, array(
            $this->Url->build(['controller' => 'Kids', 'action' => 'index', 'admin' => true]),
            'class' => 'form_filter',
            'type' => 'get',
        ));
        ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    echo $this->Form->control('relationship_id', [
                        ...
                        'label' =>  __d('setting', 'relationship'),
                        'value' => isset($data_search['relationship_id']) && !empty($data_search['relationship_id']) ? $data_search['relationship_id'] : array()
