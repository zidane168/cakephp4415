...
<script>
	...
	$(document).ready(function() {	
		...
		MULTI_IMAGE_UPLOADS.lst_edit_material  = [];
		MULTI_IMAGE_UPLOADS.lst_edit_material_string = '<?php echo isset($images_edit_data) && !empty($images_edit_data) ? $images_edit_data : '' ?>';
