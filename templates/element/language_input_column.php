...
$arr_title = array(
	...
	'nick_name' 			=>  '<font color="red">*</font>' .  __d('parent', 'nick_name'),
...
<?php if ((isset($languages_list) && !empty($languages_list))) : ?>
	...
	<?php
	if (isset($languages_edit_data) && !empty($languages_edit_data)) {
	...
	<div class="row" style="<?= (isset($hidden) && $hidden) ? 'display: none;' : ' ' ?>;  margin-bottom: 10px">
		...
		?>
				<div class="col-md-12 py-3" style="text-align: left;">
